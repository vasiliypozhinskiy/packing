...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.App_info.setGeometry(QtCore.QRect(10, 10, 791, 31))
        self.App_info.setObjectName("App_info")
        self.treeWidget = QtWidgets.QTreeWidget(self.centralwidget)
        self.treeWidget.setGeometry(QtCore.QRect(10, 90, 640, 430))
        ...
        self.treeWidget.setEditTriggers(QtWidgets.QAbstractItemView.AnyKeyPressed|QtWidgets.QAbstractItemView.DoubleClicked|QtWidgets.QAbstractItemView.EditKeyPressed)
        ...
        self.comboBox.setGeometry(QtCore.QRect(12, 50, 601, 22))
        self.comboBox.setObjectName("comboBox")
        self.toolButton = QtWidgets.QToolButton(self.centralwidget)
        self.toolButton.setGeometry(QtCore.QRect(620, 50, 31, 21))
        self.toolButton.setObjectName("toolButton")
        self.Delete_button = QtWidgets.QPushButton(self.centralwidget)
        self.Delete_button.setGeometry(QtCore.QRect(660, 90, 141, 28))
        self.Delete_button.setObjectName("Delete_button")
        self.Add_category_button = QtWidgets.QPushButton(self.centralwidget)
        self.Add_category_button.setGeometry(QtCore.QRect(660, 130, 141, 28))
        self.Add_category_button.setObjectName("Add_category_button")
        self.Add_item_button = QtWidgets.QPushButton(self.centralwidget)
        self.Add_item_button.setGeometry(QtCore.QRect(660, 170, 141, 28))
        self.Add_item_button.setObjectName("Add_item_button")
        self.lcdNumber = QtWidgets.QLCDNumber(self.centralwidget)
        self.lcdNumber.setGeometry(QtCore.QRect(550, 520, 100, 51))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.label.setGeometry(QtCore.QRect(420, 530, 121, 31))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Общий вес, кг:"))
